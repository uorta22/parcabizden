      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Hesap oluşturun ve garajınızı yönetin</p>
          </div>
          ...
          <div className="bg-dark-800 border border-dark-700 rounded-2xl p-6 md:p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                <label htmlFor="register-name" className="block text-gray-300 text-sm font-medium mb-2">Ad Soyad</label>
              ...
              <div>
                <label htmlFor="register-email" className="block text-gray-300 text-sm font-medium mb-2">E-posta</label>
                <div className="relative">
              ...
              <div>
                <label htmlFor="register-phone" className="block text-gray-300 text-sm font-medium mb-2">Telefon (Opsiyonel)</label>
                <div className="relative">
              ...
              <div>
                <label htmlFor="register-password" className="block text-gray-300 text-sm font-medium mb-2">Şifre</label>
                <div className="relative">
