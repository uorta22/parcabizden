    ...
    <div className="min-h-screen py-8 md:py-12">
      <div className="container mx-auto px-4">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-500 mb-8">
          ...
          <span className="text-gray-900">Şase Sorgula</span>
        </nav>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 text-center">
              ...
              <h3 className="text-gray-900 font-semibold mb-2">Araç Ruhsatı</h3>
            ...
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 text-center">
              ...
              <h3 className="text-gray-900 font-semibold mb-2">Ön Cam</h3>
              <p className="text-gray-500 text-sm">
            ...
            <div className="bg-white border border-gray-200 shadow-sm rounded-xl p-6 text-center">
              ...
              <h3 className="text-gray-900 font-semibold mb-2">Kapı Çerçevesi</h3>
              <p className="text-gray-500 text-sm">
            ...
            {faqs.map((faq, index) => (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-gray-900 font-semibold mb-2">{faq.question}</h3>
