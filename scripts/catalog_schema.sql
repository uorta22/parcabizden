...
-- Foreign key'ler OLMADAN — veri bütünlüğü sorunları nedeniyle
-- Import sonrası gerekirse FK eklenebilir
...
-- ============================================
-- MANUFACTURERS (Üreticiler/Markalar) — 457 satır
-- ============================================
...
-- ============================================
-- VEHICLES (Araçlar — KType bazlı) — 27.125 satır
-- ============================================
...
-- ============================================
-- CATEGORIES (Parça Kategorileri) — 27.185 satır
-- ============================================
...
-- ============================================
-- SUPPLIERS (Tedarikçiler) — 662 satır
-- ============================================
...
-- ============================================
-- VEHICLE_ENGINES (Araç-Motor İlişkisi) — 62.121 satır
-- ============================================
...
-- ============================================
-- VEHICLE_ATTRIBUTES (Araç Özellikleri) — 1.724.286 satır
-- ============================================
...
-- ============================================
-- PARTS (Parçalar) — 3.920.229 satır
-- ============================================
...
-- ============================================
-- PART_VEHICLES (Parça-Araç-Kategori İlişkisi) — 78.718.888 satır
-- ============================================
...
-- ============================================
-- PART_IMAGES (Parça Görselleri) — 5.352.630 satır
-- ============================================
...
-- ============================================
-- CROSS_REF (Muadil/Alternatif Parça Referansları) — 334.152 satır
-- ============================================
